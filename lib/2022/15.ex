...
aoc 2022, 15 do
  def p1(input) do
    ...
    sensors =
      Enum.map(sensors_and_beacons, fn {sensor_x, sensor_y, _, _, distance} ->
    ...
    row_empty_ranges =
      for y <- 0..4_000_000 do
        ...
        empty_x_ranges =
          ...
          # Union ranges to remove overlap
          |> ranges_union
    ...
    (x * 4_000_000 + y) |> IO.inspect(label: "Tuning frequency")
  end
